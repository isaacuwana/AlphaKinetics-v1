// Fix for local fallback data structure in experimental design

// Override the runExperimentalDesign function to fix the local fallback
    ...
    (async () => {
        try {
            const payload = {
                ...
                selected_designs: [],
                n_experiments: nExperiments, // Add number of experiments
            ...
            // Use server response directly (it provides expectedPrecision, experiments, etc.)
